...
<section class="sec1">
    <div class="sec1-div2">
        Faça o download da versão mais recente do CodeQuest clicando no botão abaixo.
    </div>

    <a href="https://drive.google.com/drive/folders/1Ea8yMIcgQc002MJvvEnp9RWXRN3bOOcZ?usp=drive_link">
        <div class="sec1-div1 download-button">
            <img src="img/download2.png" alt="download">
            <span>Baixe agora e comece sua jornada!</span>
        </div>
    </a>
</section>
